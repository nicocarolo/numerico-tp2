...
plot(T,soluciones(:,1,1,epsylon),'c',T,soluciones(:,1,2,epsylon),'r',T,soluciones(:,1,3,epsylon),'g'
,T,soluciones(:,1,4,epsylon),'m',t23con1,u23con1(:,1),'-.b',t45con1,u45con1(:,1),'-k');
title(strcat('Epsylon = ' , num2str(epsylon)));
xlabel('t');
ylabel('v(t)');
legend('Euler','RK2','RK4','Nystrom','ODE23','ODE45','Location','eastoutside');
...
plot(T,soluciones(:,1,1,epsylon),'c',T,soluciones(:,1,2,epsylon),'r',T,soluciones(:,1,3,epsylon),'g'
,T,soluciones(:,1,4,epsylon),'m',t23con2,u23con2(:,1),'-.b',t45con2,u45con2(:,1),'-k');
title(strcat('Epsylon = ' , num2str(epsylon)));
xlabel('t');
ylabel('v(t)');
legend('Euler','RK2','RK4','Nystrom','ODE23','ODE45','Location','eastoutside');
...
%print -djpg vt2.jpg
epsylon = 3;
figure(6,'Name', 'v(t) vs t','Position',[50,50,1600,750]);
plot(T,soluciones(:,1,1,epsylon),'c',T,soluciones(:,1,2,epsylon),'r',T,soluciones(:,1,3,epsylon),'g'
,T,soluciones(:,1,4,epsylon),'m',t23con3,u23con3(:,1),'-.b',t45con3,u45con3(:,1),'-k');
title(strcat('Epsylon = ' , num2str(epsylon)));
xlabel('t');
ylabel('v(t)');
legend('Euler','RK2','RK4','Nystrom','ODE23','ODE45','Location','eastoutside');
...
plot(T,soluciones(:,1,1,epsylon),'c',T,soluciones(:,1,2,epsylon),'r',T,soluciones(:,1,3,epsylon),'g'
,T,soluciones(:,1,4,epsylon),'m',t23con4,u23con4(:,1),'-.b',t45con4,u45con4(:,1),'-k');
title('Epsylon = 4');
xlabel('t');
ylabel('v(t)');
legend('Euler','RK2','RK4','Nystrom','ODE23','ODE45','Location','eastoutside');
...
plot(T,soluciones(:,1,1,epsylon),'c',T,soluciones(:,1,2,epsylon),'r',T,soluciones(:,1,3,epsylon),'g'
,T,soluciones(:,1,4,epsylon),'m',t23con5,u23con5(:,1),'-.b',t45con5,u45con5(:,1),'-k');
title(strcat('Epsylon = ' , num2str(epsylon)));
xlabel('t');
ylabel('v(t)');
legend('Euler','RK2','RK4','Nystrom','ODE23','ODE45','Location','eastoutside');
...
%print -djpg vt5.jpg
epsylon = 1;
figure(9,'Name', "v'(t) vs t",'Position',[50,50,1600,750]);
plot(T,soluciones(:,2,1,epsylon),'c',T,soluciones(:,2,2,epsylon),'r',T,soluciones(:,2,3,epsylon),'g'
,T,soluciones(:,2,4,epsylon),'m',t23con1,u23con1(:,2),'-.b',t45con1,u45con1(:,2),'-k');
title(strcat('Epsylon = ' , num2str(epsylon)));
xlabel('t');
ylabel('v´(t)');
legend('Euler','RK2','RK4','Nystrom','ODE23','ODE45','Location','eastoutside');
...
plot(T,soluciones(:,2,1,epsylon),'c',T,soluciones(:,2,2,epsylon),'r',T,soluciones(:,2,3,epsylon),'g'
,T,soluciones(:,2,4,epsylon),'m',t23con2,u23con2(:,2),'-.b',t45con2,u45con2(:,2),'-k');
title(strcat('Epsylon = ' , num2str(epsylon)));
xlabel('t');
ylabel('v´(t)');
legend('Euler','RK2','RK4','Nystrom','ODE23','ODE45','Location','eastoutside');
...
plot(T,soluciones(:,2,1,epsylon),'c',T,soluciones(:,2,2,epsylon),'r',T,soluciones(:,2,3,epsylon),'g'
,T,soluciones(:,2,4,epsylon),'m',t23con3,u23con3(:,2),'-.b',t45con3,u45con3(:,2),'-k');
title(strcat('Epsylon = ' , num2str(epsylon)));
xlabel('t');
ylabel('v´(t)');
legend('Euler','RK2','RK4','Nystrom','ODE23','ODE45','Location','eastoutside');
...
%print -djpg vpt3.jpg
epsylon = 4;
figure(12,'Name', "v'(t) vs t",'Position',[50,50,1600,750]);
plot(T,soluciones(:,2,1,epsylon),'c',T,soluciones(:,2,2,epsylon),'r',T,soluciones(:,2,3,epsylon),'g'
,T,soluciones(:,2,4,epsylon),'m',t23con4,u23con4(:,2),'-.b',t45con4,u45con4(:,2),'-k');
title('Epsylon = 4');
xlabel('t');
ylabel('v´(t)');
legend('Euler','RK2','RK4','Nystrom','ODE23','ODE45','Location','eastoutside');
...
plot(T,soluciones(:,2,1,epsylon),'c',T,soluciones(:,2,2,epsylon),'r',T,soluciones(:,2,3,epsylon),'g'
,T,soluciones(:,2,4,epsylon),'m',t23con5,u23con5(:,2),'-.b',t45con5,u45con5(:,2),'-k');
title('Epsylon = 5');
xlabel('t');
ylabel('v´(t)');
legend('Euler','RK2','RK4','Nystrom','ODE23','ODE45','Location','eastoutside');
...
%print -djpg vpt5.jpg
epsylon = 1;
figure(14,'Name', "v(t) vs v'(t)",'Position',[50,50,1600,750]);
plot(soluciones(:,1,1,epsylon),soluciones(:,2,1,epsylon),'c',soluciones(:,1,2,epsylon),soluciones(:,2,2,epsylon),'r',soluciones(:,1,3,epsylon),soluciones(:,2,3,epsylon),'g'
,soluciones(:,1,4,epsylon),soluciones(:,2,4,epsylon),'m',u23con1(:,1),u23con1(:,2),'-.b',u45con1(:,1),u45con1(:,2),'-k');
title(strcat('Epsylon = ' , num2str(epsylon)));
xlabel('v(t)');
ylabel('v´(t)');
legend('Euler','RK2','RK4','Nystrom','ODE23','ODE45','Location','eastoutside');
...
plot(soluciones(:,1,1,epsylon),soluciones(:,2,1,epsylon),'c',soluciones(:,1,2,epsylon),soluciones(:,2,2,epsylon),'r',soluciones(:,1,3,epsylon),soluciones(:,2,3,epsylon),'g'
,soluciones(:,1,4,epsylon),soluciones(:,2,4,epsylon),'m',u23con2(:,1),u23con2(:,2),'-.b',u45con2(:,1),u45con2(:,2),'-k');
title('Epsylon = 2');
xlabel('v(t)');
ylabel('v´(t)');
legend('Euler','RK2','RK4','Nystrom','ODE23','ODE45','Location','eastoutside');
...
%print -djpg vvp2.jpg
epsylon = 3;
figure(16,'Name', "v(t) vs v'(t)",'Position',[50,50,1600,750]);
plot(soluciones(:,1,1,epsylon),soluciones(:,2,1,epsylon),'c',soluciones(:,1,2,epsylon),soluciones(:,2,2,epsylon),'r',soluciones(:,1,3,epsylon),soluciones(:,2,3,epsylon),'g'
,soluciones(:,1,4,epsylon),soluciones(:,2,4,epsylon),'m',u23con3(:,1),u23con3(:,2),'-.b',u45con3(:,1),u45con3(:,2),'-k');
title(strcat('Epsylon = ' , num2str(epsylon)));
xlabel('v(t)');
ylabel('v´(t)');
legend('Euler','RK2','RK4','Nystrom','ODE23','ODE45','Location','eastoutside');
...
%print -djpg vvp3.jpg
epsylon = 4;
figure(17,'Name', "v(t) vs v'(t)",'Position',[50,50,1600,750]);
plot(soluciones(:,1,1,epsylon),soluciones(:,2,1,epsylon),'c',soluciones(:,1,2,epsylon),soluciones(:,2,2,epsylon),'r',soluciones(:,1,3,epsylon),soluciones(:,2,3,epsylon),'g'
,soluciones(:,1,4,epsylon),soluciones(:,2,4,epsylon),'m',u23con4(:,1),u23con4(:,2),'-.b',u45con4(:,1),u45con4(:,2),'-k');
title(strcat('Epsylon = ' , num2str(epsylon)));
xlabel('v(t)');
ylabel('v´(t)');
legend('Euler','RK2','RK4','Nystrom','ODE23','ODE45','Location','eastoutside');
...
%print -djpg vvp4.jpg
epsylon = 5;
figure(18,'Name', "v(t) vs v'(t)",'Position',[50,50,1600,750]);
plot(soluciones(:,1,1,epsylon),soluciones(:,2,1,epsylon),'c',soluciones(:,1,2,epsylon),soluciones(:,2,2,epsylon),'r',soluciones(:,1,3,epsylon),soluciones(:,2,3,epsylon),'g'
,soluciones(:,1,4,epsylon),soluciones(:,2,4,epsylon),'m',u23con5(:,1),u23con5(:,2),'-.b',u45con5(:,1),u45con5(:,2),'-k');
title(strcat('Epsylon = ' , num2str(epsylon)));
xlabel('v(t)');
ylabel('v´(t)');
legend('Euler','RK2','RK4','Nystrom','ODE23','ODE45','Location','eastoutside');
